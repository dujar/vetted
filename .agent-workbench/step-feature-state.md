...
| 5    | 2     | frontend-screens   | step-5-frontend-screens/      | planned | 1          | Sep 13–24 (starts parallel with step 2) | frontend/src/pages, frontend/src/lib, frontend tests |
| 6    | 2     | replica-assets     | step-6-replica-assets/        | planned | 1, 2       | Sep 19–26           | contracts/replicas/** (own foundry project), scripts/deploy/replicas/, demo/assets.md |
