...
2. Gas report: re-measure full guard execution + probes on 421614 and 4663 receipts; commit `gas-report.md` with the ≤200,000 assertion (spec.md:51) and drift vs the step-2 spike actuals explained.
